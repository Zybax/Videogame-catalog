      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Fresh Tomatoes Games Trailers</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer}" data-toggle="modal" data-target="#trailer">
    <img class="poster" src="{image}" width="220" height="342">
    <h2>{name}</h2>
</div>
'''
...
def open_movies_page(movies):
    ...
    output_file = open('videogame.html', 'w')

    # Replace the movie tiles placeholder generated content
    rendered_content = main_page_content.format(
        name=create_movie_tiles_content(movies))
